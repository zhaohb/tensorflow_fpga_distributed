...
def train(mnist):
    ...
    with tf.Session() as sess:
        ...
        print("exit trian_step")
        test_x = np.reshape(mnist.test.images[0:1000],[-1,INPUT_SIZE,INPUT_SIZE,1])
        test_y = mnist.test.labels[0:1000]
        feed_test = {
            input_x : test_x,
            input_y : test_y,
